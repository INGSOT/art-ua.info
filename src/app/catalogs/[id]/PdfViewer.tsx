    ...
    return (
      <div className="w-full aspect-[1/1.4142] flex flex-col items-center justify-center gap-3 bg-white px-4">
        <p className="text-[#343434] text-sm font-bold text-center">
          Не вдалося показати перегляд PDF
        </p>
        <a
          href={url}
          target="_blank"
    ...
    <div className="flex flex-col gap-2">
      <div className="flex flex-wrap items-center justify-between gap-2 px-1">
        ...
        {numPages !== null && numPages > 1 && (
          <div className="flex items-center gap-3">
            ...
            >
              <Image src="/arrow-chevron-left-yellow.svg" alt="Попередня сторінка" width={14} height={14} />
            </button>
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center bg-[#414141] hover:bg-[#4d4d4d] disabled:opacity-30 transition-colors"
            >
              <Image src="/arrow-chevron-right-yellow.svg" alt="Наступна сторінка" width={14} height={14} />
            </button>
          </div>
        )}
      </div>
      ...
      <div ref={containerRef} className="w-full overflow-auto flex justify-center bg-[#2a2a2a] py-4">
        <Document
          ...
          loading={<p className="text-white text-sm py-20">Завантаження PDF...</p>}
          error={<p className="text-white text-sm py-20">Не вдалося завантажити PDF</p>}
        >
          {(pageWidth || pageHeight) && (
            <div key={pageNumber} className="animate-page-flip shadow-2xl">
              <Page
                ...
                loading={<p className="text-white text-sm py-20">Завантаження сторінки...</p>}
              />
            </div>
          )}
        </Document>
