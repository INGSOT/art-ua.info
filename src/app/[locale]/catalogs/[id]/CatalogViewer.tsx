...
export default async function CatalogViewer({ catalog }: { catalog: PublicCatalog }) {
  const t = await getTranslations("Catalogs.viewer");
          ...
          <div className="bg-[#343434] p-4 flex flex-col gap-3">
            {catalog.rootCategoryName && (
              <div className="flex items-center justify-between gap-2">
                <span className="font-wix text-white/60 text-xs">{t("direction")}</span>
            ...
            {catalog.artCategoryName && catalog.artCategoryName !== catalog.rootCategoryName && (
              <div className="flex items-center justify-between gap-2">
                <span className="font-wix text-white/60 text-xs">{t("category")}</span>
                <span className="font-wix text-white text-sm font-bold text-right">
            ...
            {publishedDate && (
              <div className="flex items-center justify-between gap-2">
                <span className="font-wix text-white/60 text-xs">{t("published")}</span>
