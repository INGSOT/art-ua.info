...
export default function ServicesFilterSidebar({
  ...
  return (
    <div className={`flex flex-col w-full lg:w-[300px] flex-shrink-0 ${className}`}>
      <Unit title={t("priceTitle")} isLast={false}>
        <div className="flex flex-col gap-4 px-1 py-2">
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              <label className="font-wix text-white text-sm mb-1 block">{t("priceFromLabel")}</label>
              <input
                type="text"
                inputMode="numeric"
                value={minPriceInput}
            ...
            <div className="flex-1">
              <label className="font-wix text-white text-sm mb-1 block">{t("priceToLabel")}</label>
              <input
                type="text"
                inputMode="numeric"
                value={maxPriceInput}
      ...
      <Unit title={t("locationTitle")} isLast={false}>
        <div className="relative w-full">
          <div className="relative w-full h-[50px]">
            ...
            <button
              ...
              aria-label={t("locationSearchAria")}
            >
