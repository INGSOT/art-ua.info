            ...
            <div className="flex items-stretch w-full border-b border-[#272727]">
              ...
              <AccordionTrigger className="flex items-center justify-center p-3 bg-[#343434] hover:no-underline group border-l border-[#272727]">
                <div className="w-[60px] h-[60px] bg-transparent group-hover:bg-[#FECC39] group-data-[state=open]:bg-[#FECC39] flex items-center justify-center transition-colors">
                  <img className="w-6 h-6 block group-hover:hidden group-data-[state=open]:hidden" alt={t("toggleIconAlt")} src="/yellow_triangle_up.svg" />
                  <img className="w-6 h-6 hidden group-hover:block group-data-[state=open]:hidden" alt={t("toggleIconHoverAlt")} src="/grey_triangle_up.svg" />
                  <img className="w-6 h-6 hidden group-data-[state=open]:block" alt={t("toggleIconOpenAlt")} src="/grey_triangle_down.svg" />
                </div>
              </AccordionTrigger>
            </div>
