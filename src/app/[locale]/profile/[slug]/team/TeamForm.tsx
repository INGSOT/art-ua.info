...
export default function TeamForm({ mode = "create" }: TeamFormProps) {
  ...
  const handlePrimary = async () => {
    ...
    const requiredChecks: Array<[(typeof FIELD_ORDER)[number], boolean, string]> = [
      ...
      ["name.en", !nameEn.trim(), t("nameEnRequiredError")],
      ["country.uk", !countryUa.trim(), t("countryUaRequiredError")],
      ["country.en", !countryEn.trim(), t("countryEnRequiredError")],
      ["city.uk", !cityUa.trim(), t("cityUaRequiredError")],
      ["city.en", !cityEn.trim(), t("cityEnRequiredError")],
      ["region.uk", !regionUa.trim(), t("regionUaRequiredError")],
      ["region.en", !regionEn.trim(), t("regionEnRequiredError")],
      ["zip.uk", !zipUa.trim(), t("zipUaRequiredError")],
      ["zip.en", !zipEn.trim(), t("zipEnRequiredError")],
      ["specialization.uk", !specializationUa.trim(), t("specializationUaRequiredError")],
      ["specialization.en", !specializationEn.trim(), t("specializationEnRequiredError")],
      ["description.uk", !aboutUa.trim(), t("descriptionUaRequiredError")],
      ["description.en", !aboutEn.trim(), t("descriptionEnRequiredError")],
    ];
  ...
  return (
    <div className="flex flex-col items-center gap-8 px-4 py-10 md:px-10 lg:px-[75px] bg-[#414141] min-h-screen">
      ...
      <form className="flex flex-col items-center gap-8 w-full max-w-[1000px]">
          ...
          >
            {teamCover ? (
              ...
              <>
                ...
                <p className="text-white text-center">{t("coverUploadHint")}</p>
              </>
            )}
          </div>
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          >
            ...
            <input
              ...
              placeholder={t("nameUaPlaceholder")}
        ...
        {/* Website */}
        <div className="w-full flex flex-col gap-2">
          <label className="font-wix text-white text-sm">{t("websiteLabel")}</label>
          <input
            ref={websiteRef}
            type="text"
            value={websiteUrl}
          ...
          <div className="w-full md:flex-1 md:max-w-[494px] flex flex-col gap-2">
            ...
            <div className={`relative ${fieldErrors["country.uk"] ? "border-2 border-red-500" : ""}`}>
              ...
              <input
                ...
                placeholder={t("countryUaPlaceholder")}
                className="font-wix w-full pl-14 pr-6 py-4 bg-[#343434] text-white placeholder-[#A0A0A0]"
              />
            </div>
          ...
          <div className="w-full md:flex-1 md:max-w-[494px] flex flex-col gap-2">
            ...
            <div className={`relative ${fieldErrors["city.uk"] ? "border-2 border-red-500" : ""}`}>
              ...
              <input
                ...
                placeholder={t("cityUaPlaceholder")}
                className="font-wix w-full pl-14 pr-6 py-4 bg-[#343434] text-white placeholder-[#A0A0A0]"
              />
            </div>
          ...
          <div className="w-full md:flex-1 md:max-w-[494px] flex flex-col gap-2">
            ...
            <div className={`relative ${fieldErrors["region.uk"] ? "border-2 border-red-500" : ""}`}>
              ...
              <input
                ...
                placeholder={t("regionUaPlaceholder")}
                className="font-wix w-full pl-14 pr-6 py-4 bg-[#343434] text-white placeholder-[#A0A0A0]"
              />
            </div>
            ...
            <div className={`relative ${fieldErrors["region.en"] ? "border-2 border-red-500" : ""}`}>
              ...
              <input
                ...
                placeholder={t("regionEnPlaceholder")}
                className="font-wix w-full pl-14 pr-6 py-4 bg-[#343434] text-white placeholder-[#A0A0A0]"
              />
            </div>
          ...
          <div className="w-full md:flex-1 md:max-w-[494px] flex flex-col gap-2">
            ...
            <div className={`relative ${fieldErrors["zip.uk"] ? "border-2 border-red-500" : ""}`}>
              ...
              <input
                ...
                placeholder={t("zipUaPlaceholder")}
                className="font-wix w-full pl-14 pr-6 py-4 bg-[#343434] text-white placeholder-[#A0A0A0]"
              />
            </div>
            ...
            <div className={`relative ${fieldErrors["zip.en"] ? "border-2 border-red-500" : ""}`}>
              ...
              <input
                ...
                placeholder={t("zipEnPlaceholder")}
                className="font-wix w-full pl-14 pr-6 py-4 bg-[#343434] text-white placeholder-[#A0A0A0]"
              />
            </div>
        ...
        <div className="w-full flex flex-col gap-2">
          <label className="font-wix text-white text-sm">
            {t("specializationLabel")} <span className="text-red-500">*</span>
          </label>
          <div className={`relative ${fieldErrors["specialization.uk"] ? "border-2 border-red-500" : ""}`}>
            ...
            <input
              ...
              placeholder={t("specializationUaPlaceholder")}
              className="font-wix w-full pl-14 pr-6 py-4 bg-[#343434] text-white placeholder-[#A0A0A0]"
            />
          </div>
        ...
        <div className="w-full flex flex-col gap-2">
          <label className="font-wix text-white text-sm">
            {t("aboutLabel")} <span className="text-red-500">*</span>
          </label>
          <div className={`relative ${fieldErrors["description.uk"] ? "border-2 border-red-500" : ""}`}>
            ...
            <textarea
              ...
              placeholder={t("aboutUaPlaceholder")}
