...
export default function TeamServiceForm({ mode = "create" }: TeamServiceFormProps) {
  ...
  const handlePublish = async () => {
    ...
    if (!serviceNameUa.trim()) {
      setFieldErrors({ "title.uk": [t("titleRequiredError")] });
      return;
    }
    if (!artCategory) {
      setFieldErrors({ art_category: [t("categoryRequiredError")] });
      return;
    }
  ...
  if (!teamSlug) {
    return (
      <div className="flex flex-col items-center gap-4 px-4 py-10 bg-[#414141] min-h-screen">
        <p className="text-white">{tTeam("teamNotFound")}</p>
      </div>
    );
  }
  ...
  if (isMissingEditTarget) {
    return (
      <div className="flex flex-col items-center gap-4 px-4 py-10 bg-[#414141] min-h-screen">
        <p className="text-white">{t("serviceNotFound")}</p>
      </div>
    );
  }
    ...
    <div className="flex flex-col items-center gap-8 px-4 py-10 md:px-10 lg:px-[75px] bg-[#414141] min-h-screen">
      ...
      <form className="flex flex-col items-center gap-8 w-full max-w-[1000px]">
        ...
        <div className="w-full flex flex-col gap-2">
          <label className="font-wix text-white text-sm">{t("serviceNameLabel")}</label>
          <div className={`relative ${titleUaError ? "border-2 border-red-500" : ""}`}>
            ...
            <input
              ...
              placeholder={t("serviceNameUaPlaceholder")}
        ...
        <div className="w-full flex flex-col gap-2">
          <label className="font-wix text-white text-sm">
            {t("artCategoryLabel")} <span className="text-red-500">*</span>
          </label>
          <button
          ...
          >
            <span>{categoryLabel || t("artCategoryPlaceholder")}</span>
        ...
        <div className="w-full flex flex-col gap-4">
          <h2 className="text-white text-[20px] font-bold">{t("costTitle")}</h2>
          ...
          <div className="flex justify-center">
            <span className="font-wix text-white">{t("orDivider")}</span>
          </div>
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <div className="relative">
            ...
            <textarea
              ...
              placeholder={t("descriptionUaPlaceholder")}
        ...
        <div className="w-full flex flex-col gap-6">
          <h2 className="text-white text-[20px] font-bold">{t("optionsTitle")}</h2>
        ...
        >
          <span className="flex items-center justify-center flex-1 px-6 font-bold text-[#343434]">
            {isEditMode ? t("saveButton") : t("publishButton")}
          </span>
