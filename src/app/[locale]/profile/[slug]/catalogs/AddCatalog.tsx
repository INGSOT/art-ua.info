...
export default function AddCatalog({
  ...
  const t = useTranslations("Profile.catalogs.addModal");
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > MAX_IMAGE_SIZE_BYTES) {
      setImageError(t("imageTooLargeError", { maxMb: MAX_IMAGE_SIZE_BYTES / 1024 / 1024 }));
      e.target.value = "";
      return;
    }
  ...
  const handleCatalogChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > MAX_PDF_SIZE_BYTES) {
      setPdfError(t("pdfTooLargeError", { maxMb: MAX_PDF_SIZE_BYTES / 1024 / 1024 }));
      e.target.value = "";
      return;
    }
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      setSubmitError(getApiErrorMessage(error, t("saveError")));
    } finally {
        ...
        <div className="flex-1 p-6 flex flex-col gap-6 overflow-y-auto">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-white text-sm">
              {t("titleUkLabel")} <span className="text-red-500">*</span>
            </label>
          ...
          <div className="flex flex-col gap-2">
            <label className="text-white text-sm">
              {t("titleEnLabel")} <span className="text-red-500">*</span>
            </label>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <span>{categoryLabel || t("categoryPlaceholder")}</span>
