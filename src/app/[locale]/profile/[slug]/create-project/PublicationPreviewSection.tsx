...
export default function PublicationPreviewSection({
  ...
  const t = useTranslations("CreateProject.publication");

  const previewTitle = projectNameUa.trim() || t("placeholderTitle");
  const previewGenre = selectedArtFieldLabel || t("placeholderGenre");
  ...
  return (
    <ProjectResultShowcase
      ...
      descriptionParagraphs={descriptionParagraphs.length > 0 ? descriptionParagraphs : [t("placeholderDescription")]}
