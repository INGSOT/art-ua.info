...
export default function AddParagraphBlockModal({
  ...
  const t = useTranslations("CreateProject.paragraphBlockModal");
    ...
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-full md:w-[600px] bg-[#414141] z-[56] flex flex-col">
        <div className="flex items-center justify-between p-6">
          ...
          <h2 className="text-white text-[18px] font-bold flex-1 text-center">{t("title")}</h2>
          <button
            type="button"
            onClick={onClose}
            className="w-10 h-10 flex items-center justify-center hover:bg-[#343434] transition-colors"
        ...
        <div className="flex-1 p-6 flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <label className="font-wix text-white text-sm">{t("labelUa")}</label>
            <textarea
              value={paragraphUk}
          ...
          <div className="flex flex-col gap-2">
            <label className="font-wix text-white text-sm">{t("labelEn")}</label>
            <textarea
              value={paragraphEn}
