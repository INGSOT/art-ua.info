...
import { draftsEmptyState } from "../../../../data/profileData";
  ...
  return (
    <section className="w-full bg-[#414141] pt-4 pb-8 px-4 md:px-10 lg:px-[75px]">
      {hasDrafts ? (
          ...
          <div className="mb-8 flex justify-center">
            ...
            >
              <span className="flex items-center justify-center flex-1 px-6 font-bold text-black whitespace-nowrap">
                {draftsEmptyState.createButtonText}
              </span>
                  ...
                  <CardContent className="p-0 flex flex-col gap-3">
                    <div className="relative w-full aspect-[460/316] bg-[#2A2A2A] overflow-hidden">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
                        <Image src="/arrow-chevron-right-white.svg" alt="Редагувати" width={48} height={48} />
                      </div>
        ...
        <EmptyState
          title={draftsEmptyState.message}
          description={draftsEmptyState.subMessage}
          buttonText={draftsEmptyState.createButtonText}
