    ...
    <div className="flex flex-col items-center gap-8 px-4 py-10 md:px-10 lg:px-[75px] bg-[#414141] min-h-screen">
      ...
      <form className="flex flex-col items-center gap-8 w-full max-w-[1000px]" onSubmit={(e) => e.preventDefault()}>
          ...
          >
            {data.avatar ? (
              ...
              <>
                ...
                <p className="text-white text-center text-sm px-4">Додайте аватар</p>
              </>
            )}
          </div>
        </div>
        ...
        <div className="w-full flex flex-col gap-2">
          <label className="font-wix text-white text-sm">Ім&apos;я</label>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Please specify the full name"
              className="font-wix w-full pl-14 pr-6 py-4 bg-[#343434] text-white placeholder-[#A0A0A0]"
            />
          </div>
        </div>
        ...
        {/* Profession */}
        <div className="w-full flex flex-col gap-2">
          <label className="font-wix text-white text-sm">Професія</label>
          <div className="relative">
            <div className="absolute left-4 top-1/2 -translate-y-1/2">
              <Image src="/ua.svg" alt="UA" width={24} height={24} />
            </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="For example: Director"
              className="font-wix w-full pl-14 pr-6 py-4 bg-[#343434] text-white placeholder-[#A0A0A0]"
            />
          </div>
        </div>
        ...
        <div className="w-full flex flex-col md:flex-row gap-3">
          ...
          <div className="w-full md:flex-1 flex flex-col gap-2">
            <label className="font-wix text-white text-sm">Місто</label>
            <input
              type="text"
              value={data.cityUk}
        ...
        {/* Description */}
        <div className="w-full flex flex-col gap-2">
          <label className="font-wix text-white text-sm">Про себе</label>
          <textarea
        ...
        <div className="w-full flex flex-col gap-4">
          <h2 className="text-white text-[20px] font-bold">Сайт і соцмережі</h2>
          <input
            type="text"
            value={data.website}
