    ...
    <div className="w-full max-w-[1000px] flex flex-col gap-6">
      <div className="flex flex-col gap-4">
        <p className="text-white">
          Розкажіть більше про свій проєкт. Додавайте фотографії робочого процесу, чернетки, тощо.
        </p>
        <p className="text-white">Розділ не є обов&apos;язковим.</p>
      </div>
      ...
      >
        ...
        <div className="flex items-center justify-center w-[60px] border-l border-[#343434]">
          <Image src="/plus.svg" alt="Додати блок" width={24} height={24} />
        </div>
      </button>
