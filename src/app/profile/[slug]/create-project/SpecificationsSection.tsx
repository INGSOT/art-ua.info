  ...
  return (
    <div className="w-full max-w-[1000px] flex flex-col gap-6">
      <p className="font-wix text-white text-sm w-full text-left">
        Вкажіть характеристики вашої роботи. Якщо ви малюєте картину — якого розміру вона буде?
        Знімаєте фільм — хто напише сценарій?
      </p>

      {!artCategory && (
        <p className="text-[#A0A0A0] text-center">
          Спочатку оберіть галузь мистецтва на вкладці «Назва»
        </p>
      )}
      {artCategory && isLoadingCatalog && (
        <p className="text-[#A0A0A0] text-center">Завантаження…</p>
      )}
      {artCategory && !isLoadingCatalog && catalog.length === 0 && (
        <p className="text-[#A0A0A0] text-center">Для цієї категорії немає характеристик</p>
      )}
