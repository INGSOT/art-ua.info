...
import { deleteServiceTexts } from "../../../../data/profileData";
      ...
      <div className="fixed right-0 top-0 h-full w-full md:w-[600px] bg-[#414141] z-50 flex flex-col animate-slide-in">
        ...
        <div className="flex items-center justify-between p-6">
          ...
          >
            <Image
              ...
              alt={deleteServiceTexts.closeAlt}
              width={24}
              height={24}
            />
          </button>
        ...
        <div className="flex-1 p-6 flex flex-col">
          ...
          <p className="text-white text-[16px] leading-relaxed mb-6 whitespace-pre-line">
            {deleteServiceTexts.description}
          </p>
          ...
          >
            {deleteServiceTexts.deleteButton}
          </button>
          ...
          >
            {deleteServiceTexts.cancelButton}
          </button>
        </div>
      </div>
    </>
